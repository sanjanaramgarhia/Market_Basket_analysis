...
def show_main_page():
    ...
    <style>
        /* Background */
        .stApp {
            background-image: url("https://i.ibb.co/ks3t6rZB/flat-lay-vegetables-frame.jpg");
    ...
    with chatbot:
        ...
        if st.button("Get Answer"):
            if final_question:
                ...
                st.info(f"Stemmed Tokens: {stemmed}")
                st.info(f"Lemmatized Tokens: {lemmatized}")
                st.info(f"POS Tags: {pos_tags}")
                st.info(f"Bigrams: {bigrams}")
                st.info(f"Trigrams: {trigrams}")
            else:
    ...
    with recommendations:
        ...
        if selected_item:
            ...
            if not related_rules.empty:
                ...
                st.write(f"📦People also buy together with {selected_item}")
    ...
    with about:
        ...
        **Developer Information:**  
        ...
        st.markdown("""
        ### Contact Me  
        - 🐙 [GitHub](https://github.com/sanjanaramgarhia)  
        - 💼 [LinkedIn](https://www.linkedin.com/in/sanjana-ramgarhia-b95515257/)  
